...
def process_image(
    kwargs,
):  # item_idx, item, dst_dir="realign1500", output_size=1500, transform_size=4096, enable_padding=True):
...
if __name__ == "__main__":
    ...
    recreate_aligned_images_fast(
        json_data, src_dir=args.source, dst_dir=args.dest, output_size=1500, n_threads=args.threads
    )
