...
@click.option(
    "--aug", help="Augmentation mode", type=click.Choice(["noaug", "ada", "fixed"]), default="noaug", show_default=True
)
...
@click.option(
    "--c-noise",
    help="Add noise for generator pose conditioning.",
    metavar="FLOAT",
    type=click.FloatRange(min=0),
    required=False,
    default=0,
...
@click.option(
    "--sr_noise_mode",
    help="Type of noise for superresolution",
    metavar="STR",
    type=click.Choice(["random", "none"]),
    required=False,
    default="none",
)
@click.option(
    "--resume_blur", help="Enable to blur even on resume", metavar="BOOL", type=bool, required=False, default=False
)
@click.option(
    "--sr_num_fp16_res",
...
@click.option(
    "--style_mixing_prob",
    help="Style-mixing regularization probability for training.",
    metavar="FLOAT",
    type=click.FloatRange(min=0, max=1),
    default=0,
    required=False,
...
@click.option(
    "--sr-module", help="Superresolution module override", metavar="STR", type=str, required=False, default=None
)
@click.option(
    "--density_reg",
...
@click.option(
    ...
    metavar="STR",
    type=click.Choice(["l1", "l1-alt", "monotonic-detach", "monotonic-fixed", "total-variation"]),
    required=False,
    default="l1",
)
@click.option(
