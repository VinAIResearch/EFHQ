...
def main(rank, world_size, args):
    ...
    if args.dataset == "ted":
        ...
        data_list = {
            "data_1": {
                ...
                "data_list": "./data/train_list_voxceleb1.txt",
                "data_list_test": "./data/test_list_voxceleb1.txt",
            },
            "data_2": {
                "name": "celebV",
                "root_dir": "../../data/CelebV-HQ/processed/extracted_cropped_face_results_vox_final/all",
                "data_list": "../../data/CelebV-HQ/info/reenactment/train_0.25.pt",
            ...
            "data_3": {
                ...
                "data_list": "../../data/VFHQ/info/reenactment/train_0.25.pt",
                "data_list_test": "../../data/VFHQ/info/reenactment/test_0.25.pt",
            },
        }
        dataset = Ext256(data_list, "train", False, transform, False)
        dataset_test = Ext256(data_list, "test", False, transform, False)
    ...
    for idx in pbar:
        ...
        if i % args.display_freq == 0 and rank == 0:
            print(
                "[Iter %d/%d] [vgg loss: %f] [l1 loss: %f] [g loss: %f] [d loss: %f]"
                % (
                    i,
                    args.iter,
                    vgg_loss.item(),
